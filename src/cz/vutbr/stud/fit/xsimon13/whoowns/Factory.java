...
{
    public static ParsedClassProvider createParsedClassProvider(Path root) {
        FileAccessor fileAccessor = new FileAccessor(root);
        FullyQualifiedImportResolver fullyQualifiedImportResolver = new FullyQualifiedImportResolver(fileAccessor);
        ASTLoader astLoader = new ASTLoader();
        return new ParsedClassProvider(fileAccessor, fullyQualifiedImportResolver, astLoader);
    }
}
